...
from recipesapp.models import Category, Recipe, Comment
...
def index(request):
    ...
    return render(request, 'recipesapp/index.html', context=context)
...
def about(request):
    ...
    return render(request, 'recipesapp/about.html', context=context)
...
def add_recipe(request):
    ...
    return render(request, 'recipesapp/add_recipe.html', context=context)
...
class ContactFormView(DataMixin, FormView):
    ...
    template_name = 'recipesapp/contact.html'
    ...
    # вызов метода при успешной заполнении формы обратной связи
...
def show_recipe(request, recipe_id):
    ...
    return render(request, 'recipesapp/recipe.html', context=context)
...
class LoginUser(DataMixin, LoginView):
    ...
    template_name = 'recipesapp/login.html'
...
def change_recipe(request, recipe_id: int):
    ...
    return render(request, "recipesapp/change_recipe.html", context=context)
...
def add_comment(request, recipe_id: int):
    ...
    return render(request, "recipesapp/add_comment.html", context=context)
...
def show_comments_recipe(request, recipe_id):
    ...
    return render(request, 'recipesapp/show_comments_recipe.html', context=context)
...
def delete_recipe(request, recipe_id):
    ...
    return render(request, 'recipesapp/delete_recipe.html', context=context)
...
def show_user_recipes(request):
    ...
    return render(request, 'recipesapp/user_recipes.html', context=context)
